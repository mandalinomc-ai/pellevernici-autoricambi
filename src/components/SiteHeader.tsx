    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0d1117]/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:gap-4 sm:px-6">
        <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
          <Link href="/#hero" className="group min-w-0 flex flex-col leading-tight" title="Torna alla home">
            ...
            <span className="text-[11px] uppercase tracking-[0.2em] text-zinc-500 sm:tracking-[0.2em]">
          ...
          <details className="group relative shrink-0">
            <summary className="list-none [&::-webkit-details-marker]:hidden">
              <span className="inline-flex cursor-pointer items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-zinc-200 transition hover:border-[#1565c0]/50 hover:bg-white/10 sm:px-4 sm:text-sm">
                Menu
            ...
            <div
              className="absolute left-0 right-0 top-[calc(100%+6px)] z-50 min-w-0 rounded-2xl border border-white/10 bg-[#161b22]/98 py-2 shadow-2xl shadow-black/50 backdrop-blur-xl sm:left-auto sm:right-0 sm:min-w-[280px]"
              role="menu"
            >
